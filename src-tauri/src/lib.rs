...
use crate::commands::{
    ...
    invalidate_device_cache, is_debug_mode, open_devtools, open_folder, launch_software_resource, read_chat_text_file, read_json_file,
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Fastboot 分区管理与镜像解析命令
            fastboot::img::image_parser::inspect_partition_image,
            fastboot::img::image_parser::unpack_partition_image,
            fastboot::command::fastboot_partition::get_fastboot_partitions,
            fastboot::command::fastboot_partition::fastboot_flash_partition,
            fastboot::command::fastboot_partition::fastboot_fetch_partition,
            fastboot::command::fastboot_partition::fastboot_erase_partition,
            // MCP 本地服务命令
